...
module.exports.sendEmail = async (event) => {
    ...
    try {
        await sengrid.sendMultiple({
            to: subs,
            from: "juanuribe513@gmail.com",
            subject: `[Daily Words od Wisdom]`,
...
const getSubs = async () => {
    const subscribers = await axios.get(
      "https://l36en9kyhi.execute-api.us-east-1.amazonaws.com/dev/getSubscribers"
    );
    var list = [];
...
const getQuote = async () => {
    const getQuotes = await axios.get(
      "https://l36en9kyhi.execute-api.us-east-1.amazonaws.com/dev/quotes"
    );
